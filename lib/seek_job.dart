        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Center(child: Text('Welcome to Saksham!', style: TextStyle(color: Colors.teal, fontSize: 22, fontWeight: FontWeight.bold),)),
            ),
          
            SizedBox(height: 10,),
            Padding(
              padding: const EdgeInsets.fromLTRB(20, 0, 20, 10),
              child: Center(child: Text('Enter your details', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)),
            ),
